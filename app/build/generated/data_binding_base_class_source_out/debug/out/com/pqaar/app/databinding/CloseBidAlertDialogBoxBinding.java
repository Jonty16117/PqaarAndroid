...
public final class CloseBidAlertDialogBoxBinding implements ViewBinding {
  @NonNull
  ...
  private CloseBidAlertDialogBoxBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull Button button5, @NonNull Button button6, @NonNull ConstraintLayout constraintLayout,
      @NonNull View divider12, @NonNull ImageView imageView10, @NonNull ImageView imageView11,
      @NonNull ConstraintLayout outerParent, @NonNull Spinner spinner, @NonNull TextView textView26,
      @NonNull TextView textView27, @NonNull TextView textView33, @NonNull TextView textView35,
  ...
  @NonNull
  public static CloseBidAlertDialogBoxBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CloseBidAlertDialogBoxBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.close_bid_alert_dialog_box, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CloseBidAlertDialogBoxBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CloseBidAlertDialogBoxBinding((LinearLayoutCompat) rootView, button5, button6,
          constraintLayout, divider12, imageView10, imageView11, outerParent, spinner, textView26,
          textView27, textView33, textView35, textView36);
    }
