...
public final class IncomingTruckRequestItemBinding implements ViewBinding {
  @NonNull
  ...
  private IncomingTruckRequestItemBinding(@NonNull CardView rootView, @NonNull CardView cardview,
      ...
      @NonNull TextView seqNo, @NonNull TextView textView2, @NonNull TextView textView3,
  ...
  @NonNull
  public static IncomingTruckRequestItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IncomingTruckRequestItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.incoming_truck_request_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IncomingTruckRequestItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.seqNo;
      TextView seqNo = rootView.findViewById(id);
      if (seqNo == null) {
        break missingId;
      }
      ...
      return new IncomingTruckRequestItemBinding((CardView) rootView, cardview, guideline17,
          guideline18, guideline19, guideline8, imageView12, seqNo, textView2, textView3,
