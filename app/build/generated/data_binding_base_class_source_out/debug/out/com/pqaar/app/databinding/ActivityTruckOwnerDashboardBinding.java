...
public final class ActivityTruckOwnerDashboardBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTruckOwnerDashboardBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ActivityTruckOwnerDashboardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTruckOwnerDashboardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_truck_owner_dashboard, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTruckOwnerDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTruckOwnerDashboardBinding((CoordinatorLayout) rootView, button, divider13,
